<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ include file="../header.jsp" %>
        <!-- 본문 시작 pdsList.jsp -->
          ...
          <form name="pdsfrm" id="pdsfrm" method="post" action="pdsIns.jsp" onsubmit="return pdsCheck()" enctype="multipart/form-data">
          <table class="table">
			<tr>
			    <th>이름</th>
			...
			<tr>
			    <th>비밀번호</th>
			    <td style="text-align: left"><input type="password" name="passwd" id="passwd" maxlength="15"></td>
			</tr>
			<tr>
			    <th>첨부파일</th>
